		...
		switch (sign) {
			...
			case '3': // cube root
				if (num1[1] == 0) {
					...
					num3[0] = Math.pow(polar[0], 1.0 / 3.0) * Math.cos((polar[1] / (3))); // You add a 2pi*k for other
																							// roots
					num3[1] = Math.pow(polar[0], 1.0 / 3.0) * Math.sin((polar[1] / (3))); // You add a 2pi*k for other
																							// roots
				}
				break;
			...
			case '2': // square root
				if (num1[1] == 0) {
					...
					double[] polar = polarize(num1);
					num3[0] = Math.pow(polar[0], 1.0 / 2.0) * Math.cos((polar[1] / (2))); // You add a 2pi*k for other
																							// roots
					num3[1] = Math.pow(polar[0], 1.0 / 2.0) * Math.sin((polar[1] / (2))); // You add a 2pi*k for other
																							// roots
				}
				break;
